        ...
        try:
            if self.check_redundant(current_node) == True:
                ...
                if current_node == current_node.parent.left_child:
                    ...
                    self.used_nodes.pop(current_node.function) # clearing memory
...
print("test")
>>>>>>> 6d1ca5cf07360c553787305c0d70e6df9d7f4ba2:TestingProgram/BDD/BDD_tree.py
